...
export default [
  ...
  },
  {
    ...
    name: 'Product',
    meta: { authRequired: true },
    component: () => import('./views/frontend/product/product')
  },
  {
    path: '/cart/',
    name: 'Cart',
    meta: { authRequired: true },
    component: () => import('./views/frontend/cart/cart')
  },
  {
    path: '/checkout/',
    name: 'Checkout',
    meta: { authRequired: true },
    component: () => import('./views/frontend/checkout/checkout')
  },
  {
    path: '/account/login/',
    name: 'Login',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/login/login')
  },
  {
    path: '/account/register/',
    name: 'Register',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/register/register')
  },
  {
    path: '/account/forgot-password/',
    name: 'Forgot Password',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/forgot-password/forgot-password')
  },
  {
    path: '/account/dashboard/',
    name: 'Dashboard',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/dashboard/dashboard')
  },
  {
    path: '/account/orders/',
    name: 'Orders',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/orders/orders')
  },
  {
    path: '/account/personal-details/',
    name: 'Personal Details',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/personal-details/personal-details')
  },
  {
    path: '/account/addresses/',
    name: 'Addresses',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/addresses/addresses')
  },
  {
    path: '/account/payment-details/',
    name: 'Payment Details',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/payment-details/payment-details')
  },
  {
    path: '/account/security/',
    name: 'Security',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/security/security')
  },
  {
    path: '/account/preferences/',
    name: 'Preferences',
    meta: { authRequired: true },
    component: () => import('./views/frontend/account/preferences/preferences')
  },
  {
    path: '/login/',
    name: 'Login',
